...
To be revolutionary, you’ve got to be able to do a lot more than copy code and change it.
Instead of creating them from scratch, you use existing classes that someone has already built and debugged.
